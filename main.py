...
proxies_list = [
    ...
    {"http": "http://47.252.11.233:9080", "https": "http://47.252.11.233:9080"},
    ...
    {"http": "http://47.88.85.102:3389", "https": "http://47.88.85.102:3389"},
    {"http": "http://74.208.245.106:8888", "https": "http://74.208.245.106:8888"},
    {"http": "http://66.210.33.34:8080", "https": "http://66.210.33.34:8080"},
    {"http": "http://172.191.74.198:8080", "https": "http://172.191.74.198:8080"},
    {"http": "http://159.65.221.25:80", "https": "http://159.65.221.25:80"},
    {"http": "http://5.161.103.113:80", "https": "http://5.161.103.113:80"},
    {"http": "http://23.247.136.245:80", "https": "http://23.247.136.245:80"},
    {"http": "http://50.62.183.223:80", "https": "http://50.62.183.223:80"},
]
...
async def get_servers(place_id, cursor=None, retries=480, initial_delay=0.25):
    ...
    while retries > 0:
        ...
        try:
            ...
            if response.status_code == 429:  # Rate limit error
                print(f"Rate limit hit with {proxy['http']}. Switching to another proxy...")
